            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="about.php">About us</a></li>
                   	...
                   	<li class="dropdown active" ><a href="#" data-toggle="dropdown" class="dropdown-toggle">News<b class="caret"></b></a>
...
<!-- AddThis Smart Layers END -->
	...
	<!----->
	<div class="press">
		<h3>Press Release - In 2015 - 2018</h3>
		<div class="tabs-box">
			<ul class="tabs-menu">
				<li><a href="#tab1"><span> </span>2018</a></li>
				<li><a href="#tab2"><span> </span>2017</a></li>
				<li><a href="#tab3"><span> </span>2016</a></li>
				<li><a href="#tab4"><span> </span>2015</a></li>
			</ul>
			<div class="clearfix"> </div>
			<div class="tab-grids">
