...
<!-- AddThis Smart Layers END -->
	...
	<h3>SELECT NO OF SEATS FROM THE DROPDOWN</h3>

       
        <label class="w3-text-green"><b>select no of seats</b></label>
...
<button onclick="message()">next</button>
<script>
function message(){
var s = document.getElementById('item1');

if(s.value == 1){
window.open("../missionmangal/s1.php");
}
if(s.value == 2){
window.open("../missionmangal/s2.php")
}
if(s.value == 3){
window.open("../missionmangal/s3.php")
}
if(s.value == 4){
window.open("../missionmangal/s4.php")
}
if(s.value == 5){
window.open("../missionmangal/s5.php")
}
}
</script>
