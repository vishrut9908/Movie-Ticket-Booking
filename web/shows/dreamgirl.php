		...
		<div class="col-md-4 movies-by-category movie-booking">
			...
			<div class="movie-ticket-book">
					...
					<div class="bahubali-details">
						...
						<p>2 hrs 05 mins</p>
						<h4>Director:</h4>
						<p>Raaj Shaandilyaa</p>
						<h4>Language:</h4>
						<p>Hindi</p>
						<h4>Genre:</h4>
						<p>Comedy,Drama,Romantic</p>
						<h4>Cast & Crew:</h4>
						<p> Ayushmann Khurrana ,Nushrat Bharucha ,Annu Kapoor, Ekta Kapoor ,Shobha Kapoor ,Nachiket Pantvaidya, Raaj Shaandilyaa, Nirmaan D. Singh, Raaj Shaandilyaa</p>
					</div>
				</div>
			</div>
		<div class="col-md-8 movies-dates">	
			<div class="movie-date-selection">
				<ul>
					...
					<li class="time">
						<a href="../seats/dreamgirl.php">11:00 AM</a>
					</li>
					<li class="time">
						<a href="../seats/dreamgirl.php">3:00 PM</a>
					</li>
					<li class="time">
						<a href="../seats/dreamgirl.php">6:20 PM</a>
					</li>
					<li class="time">
						<a href="../seats/dreamgirl.php">9:00 PM</a>
					</li>
				</ul>
			</div>
			<div class="movie-date-selection">
