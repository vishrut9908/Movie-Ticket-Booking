		...
		<div class="col-md-4 movies-by-category movie-booking">
			...
			<div class="movie-ticket-book">
					...
					<div class="bahubali-details">
						...
						<p>Hindi</p>
						<h4>Genre:</h4>
						<p>Acion,Adventure,Comedy</p>
						<h4>Cast & Crew:</h4>
						<p>  Tom Holland ,Samuel L. Jackson ,Zendaya, Cobie Smulders,Jon Favreau,J. B. Smoove,Jacob Batalon,Martin Starr,Marisa Tomei,Jake Gyllenhaal, Kevin Feige ,Amy Pascal ,Chris McKenna, Erik Sommers</p>
					</div>
				</div>
			</div>
		<div class="col-md-8 movies-dates">	
			<div class="movie-date-selection">
				<ul>
					...
					<li class="time">
						<a href="../seats/spiderman.php">11:00 AM</a>
					</li>
					<li class="time">
						<a href="../seats/spiderman.php">3:00 PM</a>
					</li>
					<li class="time">
						<a href="../seats/spiderman.php">6:20 PM</a>
					</li>
					<li class="time">
						<a href="../seats/spiderman.php">9:00 PM</a>
					</li>
				</ul>
			</div>
			<div class="movie-date-selection">
