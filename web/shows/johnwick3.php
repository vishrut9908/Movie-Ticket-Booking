		...
		<div class="col-md-4 movies-by-category movie-booking">
			...
			<div class="movie-ticket-book">
					...
					<div class="bahubali-details">
						...
						<p>English</p>
						<h4>Genre:</h4>
						<p>Acion,Crime,Triller</p>
						<h4>Cast & Crew:</h4>
						<p> Keanu Reeves ,Halle Berry ,Laurence Fishburne, Mark Dacascos, Asia Kate Dillon, Lance Reddick , Anjelica Huston , Ian McShane, Basil Iwanyk ,Erica Lee ,Derek Kolstad, Shay Hatten, Chris Collins, Marc Abrams</p>
					</div>
				</div>
			</div>
		<div class="col-md-8 movies-dates">	
			<div class="movie-date-selection">
				<ul>
					...
					<li class="time">
						<a href="../seats/johnwick3.php">11:00 AM</a>
					</li>
					<li class="time">
						<a href="../seats/johnwick3.php">3:00 PM</a>
					</li>
					<li class="time">
						<a href="../seats/johnwick3.php">6:20 PM</a>
					</li>
					<li class="time">
						<a href="../seats/johnwick3.php">9:00 PM</a>
					</li>
				</ul>
			</div>
			<div class="movie-date-selection">
