		...
		<div class="col-md-4 movies-by-category movie-booking">
			...
			<div class="movie-ticket-book">
					...
					<div class="bahubali-details">
						...
						<p>Hindi</p>
						<h4>Genre:</h4>
						<p>Drama,Historical</p>
						<h4>Cast & Crew:</h4>
						<p> Akshay Kumar ,Vidya Balan ,Sonakshi Sinha, Taapsee Pannu, Nithya Menen, Kirti Kulhari, Sharman Joshi, H. G. Dattatreya , Vikram Gokhale,  Cape of Good Films ,Hope Productions ,Fox Star Studios, Aruna Bhatia, Anil Naidu, R. Balki, Jagan Shakti, Nidhi Singh Dharma , Saketh Kondiparthi , Jagan Shakti</p>
					</div>
				</div>
			</div>
		<div class="col-md-8 movies-dates">	
			<div class="movie-date-selection">
				<ul>
					...
					<li class="time">
						<a href="../seats/missionmangal.php">11:00 AM</a>
					</li>
					<li class="time">
						<a href="../seats/missionmangal.php">3:00 PM</a>
					</li>
					<li class="time">
						<a href="../seats/missionmangal.php">6:20 PM</a>
					</li>
					<li class="time">
						<a href="../seats/missionmangal.php">9:00 PM</a>
					</li>
				</ul>
			</div>
			<div class="movie-date-selection">
