		...
		<div class="col-md-4 movies-by-category movie-booking">
			...
			<div class="movie-ticket-book">
					...
					<div class="bahubali-details">
						...
						<h4>Cast & Crew:</h4>
						<p> Sushant Singh Rajput ,Shraddha Kapoor ,Varun Sharma, Tahir Raj Bhasin, Naveen Polishetty, Tushar Pandey, Prateik Babbar, Saanand Verma, Mohammad Samad, Sajid Nadiadwala ,Nitesh Tiwari ,Piyush Gupta, Nikhil Mehrotra</p>
					</div>
				</div>
			</div>
		<div class="col-md-8 movies-dates">	
			<div class="movie-date-selection">
				<ul>
					...
					<li class="time">
						<a href="../seats/chhichhore.php">11:00 AM</a>
					</li>
					<li class="time">
						<a href="../seats/chhichhore.php">3:00 PM</a>
					</li>
					<li class="time">
						<a href="../seats/chhichhore.php">6:20 PM</a>
					</li>
					<li class="time">
						<a href="../seats/chhichhore.php">9:00 PM</a>
					</li>
				</ul>
			</div>
			<div class="movie-date-selection">
