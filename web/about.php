		...
		<div class="tabs-box">
			...
			<div class="tab-grids">
				<div id="tab1" class="tab-grid">
					<h5>About-us</h5>
					<p>Having a watch on latest issues we came upon one of the common issue and that is while booking people are confused in selecting a perfect located seat and to solve this issue we created a platform .
					My Show on which people booking a seat would be able to have a view of the screen from the selected seat and would be able to select a perfect seat. 
					My Show is developed with new features as compared with the old style of booking movie tickets. Old style is like booking movie tickets while standing in a long queue and not able to get perfect located seat.</p>
							...
							<div class="about-bottom-grids">
								<div class="col-sm-6 about-left">
									<div class="about-left-grids">
										...
										<div class="col-md-10 about-left-info">
											...
											<p>We started working when a common problem found that is booking movie ticket after standing in a long queue.</p>
										</div>
										<div class="clearfix"> </div>
									</div>
								</div>
								<div class="col-sm-6 about-right">
									<div class="about-left-grids">
										...
										<div class="col-md-10 about-left-info">
											<a href="#">Public suggestions</a>
											<p>As we were given suggestions that there should be a way were anyone can book a movie ticket at any place.</p>
										</div>
										<div class="clearfix"> </div>
									</div>
								</div>
							...
							<div class="about-bottom-grids">
								<div class="col-sm-6 about-left">
									<div class="about-left-grids">
										...
										<div class="col-md-10 about-left-info">
											...
											<p>It provides a facility were anyone having access to internet can access it and book movie tickets in just few minutes.</p>
										</div>
										<div class="clearfix"> </div>
									</div>
								</div>
								<div class="col-sm-6 about-right">
									<div class="about-left-grids">
										...
										<div class="col-md-10 about-left-info">
											<a href="#">New Update</a>
											<p>New update is that anyone while selecting a seat would be able to take a view of the screen from the selected seat.</p>
										</div>
										<div class="clearfix"> </div>
									</div>
								</div>
