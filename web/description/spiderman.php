...
<!-- AddThis Smart Layers END -->
	...
	<div class="m-single-article">
		<div class="article-left">
			<h3>Spiderman Far from Home<span> <i class="fa fa-heart"></i></span></h3>
			<p><a class="m-green" href="#">Action</a><a class="m-green" href="#">Adventure</a><a class="m-green" href="#">Comedy</a>
			<a class="m-orange" href="#">English/Hindi</a></p>
			<div class="clearfix"></div>
			<div class="article-time-strip">
				<div class="article-time-strip-left">
					<p>Duration <span><i class="fa fa-clock-o"></i>2 hrs 09 mins </span>  &nbsp;&nbsp; Release Date <span><i class="fa fa-calendar"></i>04 Jul, 2019</span></p>
				</div>
				<div class="clearfix"></div>
				<div class="article-img">
					<iframe src="../trailers/spiderman.mp4" frameborder="0" allowfullscreen></iframe>
				</div>
		...
		<div class="article-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
				 ...
				 <a class="show-time" href="../shows/spiderman.php">06:30 PM</a>
				 <div class="clearfix"></div>
				  <a class="more-show-time" href="../shows/spiderman.php">More Show Times</a>
			  </div>
			  <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
				 <p class="m-s-t">CINEPOLIS: Inorbit Mall, Vadodara</p>
				 <a class="show-time" href="../shows/spiderman.php">12:45 PM</a><a class="show-time" href="../shows/spiderman.php">06:30 PM</a>
				 <div class="clearfix"></div>
				 <a class="more-show-time" href="../shows/spiderman.php">More Show Times</a>
			  </div>
			</div>
	...
	<div class="reviews-tabs">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p><strong> Director :</strong> <a href="#">Jon Watts</a></p>
          <p> <strong>Crew :</strong> <a href="#">Kevin Feige</a> ,<a href="#">Amy Pascal</a> ,<a href="#">Chris McKenna</a>, <a href="#">Erik Sommers</a></p>
          <p> <strong>Starring :</strong> <a href="#">Tom Holland</a> ,<a href="#">Samuel L. Jackson</a> ,<a href="#">Zendaya</a>, <a href="#">Cobie Smulders</a>,<a href="#">Jon Favreau</a>,<a href="#">J. B. Smoove</a>,<a href="#">Jacob Batalon</a>,<a href="#">Martin Starr</a>,<a href="#">Marisa Tomei</a>,<a href="#">Jake Gyllenhaal</a></p>
		  <p>Spider-Man: Far from Home is a 2019 American superhero film based on the Marvel Comics character Spider-Man, co-produced by Columbia Pictures and Marvel Studios, and distributed by Sony Pictures Releasing. It is the sequel to Spider-Man: Homecoming (2017) and the twenty-third film in the Marvel Cinematic Universe (MCU). The film is directed by Jon Watts, written by Chris McKenna and Erik Sommers, and stars Tom Holland as Peter Parker / Spider-Man, alongside Samuel L. Jackson, Zendaya, Cobie Smulders, Jon Favreau, J. B. Smoove, Jacob Batalon, Martin Starr, Marisa Tomei, and Jake Gyllenhaal. In Spider-Man: Far From Home, Parker is recruited by Nick Fury and Mysterio to face the Elementals while he is on a school trip to Europe. 
		  </p>
          <p>Discussions for a sequel to Spider-Man: Homecoming began by October 2016, and the project was confirmed later that year. Holland, Watts, and the writers were all set to return by the end of 2017. In 2018, Jackson and Gyllenhaal joined the cast as Fury and Mysterio, respectively. Holland revealed the sequel's title ahead of filming, which began in July 2018 and took place in England, the Czech Republic, Italy, and the New York metropolitan area. Production wrapped in October 2018. The film's marketing campaign was the most expensive for a film ever and attempted to avoid revealing spoilers for Avengers: Endgame prior to that film's April 2019 release. </p>
          <p>Spider-Man: Far From Home premiered in Hollywood on June 26, 2019, and was theatrically released in the United States on July 2. The film received positive reviews for its humor, visual effects, and performances (particularly those of Holland and Gyllenhaal). It has grossed over $1.1 billion worldwide, making it the first Spider-Man film to pass the billion-dollar mark, Sony Pictures' highest-grossing film ever, and the third-highest-grossing film of 2019. A sequel is scheduled for release on July 16, 2021. </p>
