...
<!-- AddThis Smart Layers END -->
	...
	<div class="m-single-article">
		<div class="article-left">
			<h3>JohnWick: Chapter 3 <span> <i class="fa fa-heart"></i></span></h3>
			<p><a class="m-green" href="#">Action</a><a class="m-green" href="#">Crime</a><a class="m-green" href="#">Triller</a>
			<a class="m-orange" href="#">English</a></p>
			<div class="clearfix"></div>
			<div class="article-time-strip">
				<div class="article-time-strip-left">
					<p>Duration <span><i class="fa fa-clock-o"></i>2 hrs 10 mins </span>  &nbsp;&nbsp; Release Date <span><i class="fa fa-calendar"></i>17 May, 2019</span></p>
				</div>
				<div class="clearfix"></div>
				<div class="article-img">
					<iframe src="../trailers/johnwick3.mp4" frameborder="0" allowfullscreen></iframe>
				</div>
		...
		<div class="article-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
				 ...
				 <a class="show-time" href="../shows/johnwick3.php">06:30 PM</a>
				 <div class="clearfix"></div>
				  <a class="more-show-time" href="../shows/johnwick3.php">More Show Times</a>
			  </div>
			  <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
				 <p class="m-s-t">CINEPOLIS: Inorbit Mall, Vadodara</p>
				 <a class="show-time" href="../shows/johnwick3.php">12:45 PM</a><a class="show-time" href="../shows/johnwick3.php">06:30 PM</a>
				 <div class="clearfix"></div>
				 <a class="more-show-time" href="../shows/johnwick3.php">More Show Times</a>
			  </div>
			</div>
	...
	<div class="reviews-tabs">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p><strong> Director :</strong> <a href="#">Chad Stahelski</a></p>
          <p> <strong>Crew :</strong> <a href="#">Basil Iwanyk</a> ,<a href="#">Erica Lee</a> ,<a href="#">Derek Kolstad</a>, <a href="#">Shay Hatten</a>, <a href="#">Chris Collins</a>, <a href="#">Marc Abrams</a></p>
          <p> <strong>Starring :</strong> <a href="#">Keanu Reeves</a> ,<a href="#">Halle Berry</a> ,<a href="#">Laurence Fishburne</a>, <a href="#">Mark Dacascos</a>, <a href="#">Asia Kate Dillon</a>, <a href="#">Lance Reddick</a> , <a href="#">Anjelica Huston</a> , <a href="#">Ian McShane</a></p>
          <h3>Description</h3>
		  <p>John Wick: Chapter 3 – Parabellum is a 2019 American neo-noir action thriller film starring Keanu Reeves as the eponymous character. It is the third installment in the John Wick film series, following John Wick (2014) and John Wick: Chapter 2 (2017). The film is directed by Chad Stahelski and written by Derek Kolstad, Shay Hatten, Chris Collins, and Marc Abrams, based on a story by Kolstad. It also stars Halle Berry, Laurence Fishburne, Mark Dacascos, Asia Kate Dillon, Lance Reddick, Anjelica Huston, and Ian McShane. In the film, which takes place one hour after the events of the previous film, ex-hitman John Wick finds himself on the run from legions of assassins after a $14 million contract is put on his head due to his recent actions. 
          ...
          <p>Parabellum was theatrically released in the United States on May 17, 2019, by Summit Entertainment. It has grossed $324 million worldwide, becoming the highest-grossing film of the franchise in just 10 days, and received positive reviews from critics, with praise for the action sequences, visual style, and Reeves' performance. A sequel, John Wick: Chapter 4, is in development and is set to be released on May 21, 2021.</p>
