...
<!-- AddThis Smart Layers END -->
	...
	<div class="m-single-article">
		<div class="article-left">
			<h3>Dream Girl <span> <i class="fa fa-heart"></i></span></h3>
			<p><a class="m-green" href="#">Comedy</a><a class="m-green" href="#">Drama</a><a class="m-green" href="#">Romantic</a>
			<a class="m-orange" href="#">Hindi</a></p>
			<div class="clearfix"></div>
			<div class="article-time-strip">
				<div class="article-time-strip-left">
					<p>Duration <span><i class="fa fa-clock-o"></i>2 hrs 05 mins </span>  &nbsp;&nbsp; Release Date <span><i class="fa fa-calendar"></i>13 Sep, 2019</span></p>
				</div>
				<div class="clearfix"></div>
				<div class="article-img">
					<iframe src="../trailers/dreamgirl.mp4" frameborder="0" allowfullscreen></iframe>
				</div>
		...
		<div class="article-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
				 ...
				 <a class="show-time" href="../shows/dreamgirl.php">06:30 PM</a>
				 <div class="clearfix"></div>
				  <a class="more-show-time" href="../shows/dreamgirl.php">More Show Times</a>
			  </div>
			  <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
				 <p class="m-s-t">CINEPOLIS: Inorbit Mall, Vadodara</p>
				 <a class="show-time" href="../shows/dreamgirl.php">12:45 PM</a><a class="show-time" href="../shows/dreamgirl.php">06:30 PM</a>
				 <div class="clearfix"></div>
				 <a class="more-show-time" href="../shows/dreamgirl.php">More Show Times</a>
			  </div>
			</div>
	...
	<div class="reviews-tabs">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p><strong> Director :</strong> <a href="#">Raaj Shaandilyaa</a></p>
          <p> <strong>Crew :</strong> <a href="#">Ekta Kapoor</a> ,<a href="#">Shobha Kapoor</a> ,<a href="#">Nachiket Pantvaidya</a>, <a href="#">Raaj Shaandilyaa</a>, <a href="#">Nirmaan D. Singh</a>, <a href="#">Raaj Shaandilyaa</a></p>
          <p> <strong>Starring :</strong> <a href="#">Ayushmann Khurrana</a> ,<a href="#">Nushrat Bharucha</a> ,<a href="#">Annu Kapoor</a></p>
		  <p>Dream Girl is a 2019 Indian Hindi-language comedy film directed by Raaj Shaandilyaa and co-produced by Ekta Kapoor and Shobha Kapoor under their banner Balaji Motion Pictures. It stars Ayushmann Khurrana as a cross-gender actor whose female voice impersonation begets attention from others. Nushrat Bharucha, Annu Kapoor, Manjot Singh, and Vijay Raaz feature in supporting roles. 
		  </p>
          <p>Principal photography began in December 2018. The film was theatrically released in India on 13 September 2019.</p>
