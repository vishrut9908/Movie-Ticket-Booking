...
<!-- AddThis Smart Layers END -->
	...
	<div class="m-single-article">
		<div class="article-left">
			<h3>Chhichhore <span> <i class="fa fa-heart"></i></span></h3>
			...
			<div class="article-time-strip">
				<div class="article-time-strip-left">
					<p>Duration <span><i class="fa fa-clock-o"></i>2 hrs 26 mins </span>  &nbsp;&nbsp; Release Date <span><i class="fa fa-calendar"></i>06 Sep, 2019</span></p>
				</div>
				<div class="clearfix"></div>
				<div class="article-img">
					<iframe src="../trailers/chhichhore.mp4" frameborder="0" allowfullscreen></iframe>
				</div>
		...
		<div class="article-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
				 ...
				 <a class="show-time" href="../shows/chhichhore.php">06:30 PM</a>
				 <div class="clearfix"></div>
				  <a class="more-show-time" href="../shows/chhichhore.php">More Show Times</a>
			  </div>
			  <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
				 <p class="m-s-t">CINEPOLIS: Inorbit Mall, Vadodara</p>
				 <a class="show-time" href="../shows/chhichhore.php">12:45 PM</a><a class="show-time" href="../shows/chhichhore.php">06:30 PM</a>
				 <div class="clearfix"></div>
				 <a class="more-show-time" href="../shows/chhichhore.php">More Show Times</a>
			  </div>
			</div>
	...
	<div class="reviews-tabs">
      ...
      <div class="tab-content responsive hidden-xs hidden-sm">
        <div class="tab-pane active" id="how-to">
		 <p><strong> Director :</strong> <a href="#">Nitesh Tiwari</a></p>
          <p> <strong>Crew :</strong> <a href="#">Sajid Nadiadwala</a> ,<a href="#">Nitesh Tiwari</a> ,<a href="#">Piyush Gupta</a>, <a href="#">Nikhil Mehrotra</a></p>
          <p> <strong>Starring :</strong> <a href="#">Sushant Singh Rajput</a> ,<a href="#">Shraddha Kapoor</a> ,<a href="#">Varun Sharma</a>, <a href="#">Tahir Raj Bhasin</a>, <a href="#">Naveen Polishetty</a>, <a href="#">Tushar Pandey</a>, <a href="#">Prateik Babbar</a>, <a href="#">Saanand Verma</a>, <a href="#">Mohammad Samad</a></p>
          <h3>Description</h3>
		  <p>Chhichhore (transl. Flippant) is a 2019 Indian Hindi-language coming-of-age comedy-drama film directed by Nitesh Tiwari and produced by Sajid Nadiadwala under the banner of Nadiadwala Grandson Entertainment. The film stars Sushant Singh Rajput, Shraddha Kapoor, Varun Sharma, Naveen Polishetty, Prateik Babbar, Tahir Raj Bhasin, Saanand Verma, and follows the life of seven friends from 1992 to present day. Filming began on 30 September 2018. The film was theatrically released in India on 6 September 2019. <br>
		  </p>
