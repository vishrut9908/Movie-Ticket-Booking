	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
					...
					<li class="active"><a href="contact.php">Meet Us</a></li>
				</li>
...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact">
	<h3>Contact Us</h3>
	<p class="love"> We love to here from you</p>
	<div class="contact-form">
				...
				<div class="col-md-6 contact-in">
					<p class="sed-para"> You can contact us using the form and we would contact you as soon as possible.</p>
		...
		<h4>our location</h4>
		<div class="c-map">
			<iframe src="https://www.google.com/maps/d/embed?mid=14sMilZk2juMGV82P62gX2uZQ0wM"  frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
	</div>
	</div>
