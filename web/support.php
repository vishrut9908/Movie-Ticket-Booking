...
<!-- AddThis Smart Layers END -->
	...
	<section class="help-center">	
			<div class="hc-search">
				<h3>How can we help you today?</h2>
			...
			<div class="support support2">
			  <div class="row">
			   <div class="col-lg-10">
			   	...
			   	<p>We provide 24/7 Sevice Toll free number 022 6144 5050.</p>
			   </div>
			  </div>
			</div>
			<div class="support-grid">
			   ...
			   <div class="support_grids">	
				...
				<div class="col-md-4 support-grid text-center">
					...
					<p>If you dont have access to mobile phone or any device to call then there's an option for you that is you can email to our customer care and we can help you through email. </p>
				   <a href="contact.php">Send Email</a>
				</div>
